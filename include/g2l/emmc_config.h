...
#define EMMC_WORK_DRAM_EADD_USER	EMMC_WORK_DRAM_EADD_512M
#define EMMC_WORK_DRAM_EADD_BOOT1	EMMC_WORK_DRAM_EADD_16M
#define EMMC_WORK_DRAM_EADD_BOOT2	EMMC_WORK_DRAM_EADD_16M
