...
#define RZG2L_GTM0_BASE             (0x12801000)
...
#define SCIF_BASE                   (RZG2L_SCIF0_BASE)
#define PFC_BASE                    (RZG2L_GPIO_BASE)
#define OSTM0_BASE                  (RZG2L_GTM0_BASE)


#define	INTERNAL_WORK_MEMORY_SADD	    0x0001F000
#define	INTERNAL_WORK_MEMORY_EADD	    0x0002EFFF
#define	INTERNAL_WORK_SPI_LOAD_AREA		0x0001F000

#define	DDR_WORK_MEMORY_SADD		    0x50000000
#define	DDR_WORK_MEMORY_EADD	    	0x53FFFFFF
#define	DDR_WORK_SPI_LOAD_AREA			0x58000000
