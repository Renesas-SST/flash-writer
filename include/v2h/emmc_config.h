...
#define EMMC_WORK_DRAM_EADD_USER	EMMC_WORK_DRAM_EADD
#define EMMC_WORK_DRAM_EADD_BOOT1	EMMC_WORK_DRAM_EADD
#define EMMC_WORK_DRAM_EADD_BOOT2	EMMC_WORK_DRAM_EADD
