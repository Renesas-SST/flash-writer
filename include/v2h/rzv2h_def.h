...
#define RZV2H_GTM0_BASE				UL(0x11800000)
#define	RZV2H_WDT_CA55_BASE			UL(0x14400000)
...
#define SCIF_BASE					RZV2H_SCIF_BASE
#define OSTM0_BASE                  RZV2H_GTM0_BASE
...
#define	INTERNAL_WORK_MEMORY_SADD	0x08200000
#define	INTERNAL_WORK_MEMORY_EADD	0x085FFFFF
#define INTERNAL_WORK_SPI_LOAD_AREA (INTERNAL_WORK_MEMORY_SADD)

#define	DDR_WORK_MEMORY_SADD		0x40000000
#define	DDR_WORK_MEMORY_EADD		0x4FFFFFFF
#define DDR_WORK_SPI_LOAD_AREA
